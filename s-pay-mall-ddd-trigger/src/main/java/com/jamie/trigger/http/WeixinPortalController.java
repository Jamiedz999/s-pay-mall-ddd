...
import com.jamie.types.sdk.weixin.MessageTextEntity;
import com.jamie.types.sdk.weixin.SignatureUtil;
import com.jamie.types.sdk.weixin.XmlUtil;
    ...
    public String post(@RequestBody String requestBody,
        ...
        try {
            ...
            if("event".equals(message.getMsgType()) && "SCAN".equals(message.getEvent())) {
                ...
                return buildMessageTextEntity(openid, "login success");
            }
